function [c, u, u_cost, up, A_forward, mca_info, c_min, c_max, u_min, u_max, r, u_capacity, eta_energetic, eta_saturation, multi] = ecm_enzyme_cost_minimization_HL(network,r,v,ecm_options)
...
network.N(find(ismember(network.metabolites, 'H2O')),:) = 0;
